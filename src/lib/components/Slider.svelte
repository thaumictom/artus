	...
	>
		...
		{#if thumbLabel}
			<Slider.ThumbLabel
				index={0}
				position="bottom"
				class="bg-surface opacity-0 data-active:opacity-100 group-hover:opacity-100 mt-3 px-2 border text-sm text-nowrap transition-opacity pointer-events-none"
			>
